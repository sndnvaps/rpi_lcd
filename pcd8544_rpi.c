	...
	for (;;)
	{
		...
		while (ifAddrStruct!=NULL)
		{
			...
			{   // check it is IP4 is a valid IP4 Address
				...
				if( strcmp(ifAddrStruct->ifa_name,"eth0")==0 || strcmp(ifAddrStruct->ifa_name,"wlan0")==0)
				{
